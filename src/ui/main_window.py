...
from ui.plot_section import PlotSection
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, config: dict):
        ...
        self.plot_section.addSection(self.__plot_layout)
    
        self.__page_line1.addLayout(self.__comm_layout)
        self.__page_line1.addLayout(self.__table_layout)
        self.__page_layout.addLayout(self.__page_line1)
        self.__page_layout.addLayout(self.__plot_layout)
