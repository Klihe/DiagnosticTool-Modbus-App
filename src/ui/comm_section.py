...
class CommSection(QWidget):
    ...
    def __create(self) -> None:
        ...
        self.__client = CommLine(
            descr="Client",
            options=self.__config["communication"]["client_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=False,
            refresh=False,
        )
        self.__method = CommLine(
            descr="Method",
            options=self.__config["communication"]["method_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=True,
            refresh=False,
        )
        self.__port = CommLine(
            descr="Port",
            options=self.__config["communication"]["port_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=False,
            refresh=True,
        )
        self.__baudrate = CommLine(
            descr="Baudrate",
            options=self.__config["communication"]["baudrate_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=True,
            refresh=False,
        )
        self.__bytesize = CommLine(
            descr="Byte Size",
            options=self.__config["communication"]["bytesize_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=True,
            refresh=False,
        )
        self.__parity = CommLine(
            descr="Parity",
            options=self.__config["communication"]["parity_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=True,
            refresh=False,
        )
        self.__stopbits = CommLine(
            descr="Stop Bits",
            options=self.__config["communication"]["stopbits_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=True,
            refresh=False,
        )
        ...
        self.__ip = CommLine(
            descr="IP",
            options=self.__config["communication"]["ip_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=True,
            refresh=False,
        )
        self.__server = CommLine(
            descr="Server",
            options=self.__config["communication"]["server_options"],
            default_option=self.__config["communication"]["client_default"],
            custom=False,
            refresh=False,
        )
